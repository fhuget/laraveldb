...
<html lang="en">
  ...
  <body>
      ...
      <nav class="navbar px-md-0 navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
          <a class="navbar-brand" href="index.html">Teguh<i>Media</i>.</a>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-12 ftco-animate">
            ...
            <h1 class="mb-4 mb-md-0">TEGUHMEDIA</h1>
            <div class="row">
                <div class="col-md-7">
                    <div class="text">
                        <p>Website resmi TEGUHMEDIA merupakan salah satu agensi hiburan No.1 terbesar di Indonesia, yang menaungi talenta lokal sukses</p>
                        <div class="mouse">
